//タイルレイヤーを取得
var t_attr = "<a href='https://maps.gsi.go.jp/development/ichiran.html' target='_blank'>国土地理院</a>";
var t_attr_relief = "<a href='https://maps.gsi.go.jp/development/ichiran.html' target='_blank'>国土地理院　海域部は海上保安庁海洋情報部の資料を使用して作成</a>";
var t_attr_kj = "<a href='https://ktgis.net/kjmapw/index.html' target='_blank'>今昔マップ on the web</a>";
var t_attr_nk = "<a href='https://creativecommons.org/licenses/by/4.0/legalcode.ja' target='_blank'>CC-BY（出典: 農研機構 農研機構農業環境研究部門）</a>";
/*
...
/*
var kanto_rapid = new L.tileLayer('https://aginfo.cgk.affrc.go.jp/ws/tmc/1.0.0/Kanto_Rapid-900913-L/{z}/{x}/{y}.png', {
    attribution: "<a href='https://maps.gsi.go.jp/development/ichiran.html' target='_blank'>国土地理院</a> <a href='https://www.finds.jp/siteinfo/c_tou.html.ja' target='_blank'>出典: 農研機構　CC BY</a>",
    maxZoom: 17
});

var kanto_rapid_L = new L.tileLayer('https://aginfo.cgk.affrc.go.jp/ws/tmc/1.0.0/Kanto_Rapid-900913-L/{z}/{x}/{y}.png', { opacity: 0.8, maxNativeZoom: 17, attribution: t_attr });
*/

/*
var kanto_rapid = new L.tileLayer('https://boiledorange73.sakura.ne.jp/ws/tile/Kanto_Rapid-900913/{z}/{x}/{y}.png', {
    attribution: t_attr_nk,
    maxZoom: 17
});

var kanto_rapid_L = new L.tileLayer('https://boiledorange73.sakura.ne.jp/ws/tile/Kanto_Rapid-900913/{z}/{x}/{y}.png', { opacity: 0.8, maxNativeZoom: 17, attribution: t_attr_nk });
*/

var tokyo50 = new L.tileLayer('https://ktgis.net/kjmapw/kjtilemap/tokyo50/2man/{z}/{x}/{-y}.png', {
    attribution: t_attr_kj,
    maxZoom: 17
});

var tokyo50_L = new L.tileLayer('https://ktgis.net/kjmapw/kjtilemap/tokyo50/2man/{z}/{x}/{-y}.png', { opacity: 0.8, maxNativeZoom: 17, attribution: t_attr_kj });

var t_relief_L = L.tileLayer('https://cyberjapandata.gsi.go.jp/xyz/relief/{z}/{x}/{y}.png', { opacity: 0.5, maxNativeZoom: 15, attribution: t_attr_relief });
