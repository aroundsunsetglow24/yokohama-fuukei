var maxNativeZoom_1854_by = 9, maxZoom_1854_by = 9, image_width_1854_by = 16384, image_height_1854_by = 22528;
var minZoom_1854_by = 4;
var map_1854_by = L.map('map_1854_by', {
    crs: L.CRS.Simple,
    minZoom: minZoom_1854_by,
    zoomSnap: 0.25,
    zoomDelta: 0.25,
...
$(function () {
    var mapId = 'map_1854_by';
    const attribution = "<a href='https://www.ndl.go.jp/jp/use/reproduction/index.html' target='_blank'>国立国会図書館デジタルコレクション</a>"
    const sidebarId = 'sidebar_1854_by';
    const map = map_1854_by
    const maxNativeZoom = maxNativeZoom_1854_by;
    const maxZoom = maxZoom_1854_by;
    const image_width = image_width_1854_by;
    const image_height = image_height_1854_by;
    const minZoom = minZoom_1854_by;

    var t_map = { map_1851_ymkz: "1851_横浜村並近傍之図", map_1854_by: "1854_bay of yedo", map_1859_ykjz: "1859_横浜開港地割之図", map_1860_tyf: "1860_東海道名所之内横浜風景", map_1860_ymi: "1860_横浜名所一覧（海岸）", map_1861_gkyz: "1861_御開港横濱之図", map_1861_syf: "1861_再改横浜風景", map_1865_gkyzz: "1865_御開港横浜之全図", map_1868_ymzz: 3, map_now: "現在" };
    var z_map = { map_1851_ymkz: 2, map_1854_by: 5, map_1859_ykjz: 3, map_1860_tyf: 7, map_1860_ymi: 7, map_1861_gkyz: 2, map_1861_syf: 4, map_1865_gkyzz: 4, map_1868_ymzz: 3, map_now: 16 };
    const geojson_spot = "spot_1854_by.geojson";
