var maxNativeZoom_1865_gkyzz = 7, maxZoom_1865_gkyzz = 7, image_width_1865_gkyzz = 16384, image_height_1865_gkyzz = 6144;
var minZoom_1865_gkyzz = 2;
var map_1865_gkyzz = L.map('map_1865_gkyzz', {
    crs: L.CRS.Simple,
    minZoom: minZoom_1865_gkyzz,
    zoomSnap: 0.25,
    zoomDelta: 0.25,
...
$(function () {
    var mapId = 'map_1865_gkyzz';
    const sidebarId = 'sidebar_1865_gkyzz'
    const map = map_1865_gkyzz;
    const maxNativeZoom = maxNativeZoom_1865_gkyzz;
    const maxZoom = maxZoom_1865_gkyzz;
    const minZoom = minZoom_1865_gkyzz;
    const image_width = image_width_1865_gkyzz;
    const image_height = image_height_1865_gkyzz;
    ...
    const geojson_spot = "spot_1865_gkyzz.geojson";
